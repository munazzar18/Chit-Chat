...
const onChange = (e) => {
  ...
  return (
    <>
    {msg && 
    <div id="toast-top-left" className="fixed flex items-center w-full mt-20 max-w-xs p-4 space-x-4 text-white bg-sky-500/100 divide-x divide-gray-200 rounded-lg shadow top-5 left-5 dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert">
    <div  className="text-sm font-normal">{msg}</div>
    </div>}
    <div id="toast-bottom-right" className="fixed flex items-center mb-20 w-full max-w-xs p-4 space-x-4 text-white bg-indigo-500 divide-x divide-gray-200 rounded-lg shadow right-5 bottom-5 dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert">
